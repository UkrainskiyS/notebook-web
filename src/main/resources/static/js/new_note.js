 ...
 */
function messageOk() {
    $('#modal1').removeClass('red').addClass('green').append('<div id="modal_body"></div>');
    $('#modal_body').append('<div id="modal2" class="modal-content white-text"></div><div id="modal3" class="modal-footer green white-text"></div>');
    $('#modal2').append('<h4 class="center-align">Success!</h4><p class="center-align">Note successfully saved!</p>');
    $('#modal3').append('<a href="/" id="save" class="modal-close waves-effect waves-green btn-flat white-text">Home page</a>')
        .append('<a class="modal-close waves-effect waves-green btn-flat white-text">Agree</a>');
}
 ...
 */
function nameExist() {
    $('#modal1').removeClass('green').addClass('red').append('<div id="modal_body"></div>');
